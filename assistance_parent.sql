--
-- Partitioned parent for assistance, generated by tools/csv2schema.py.
...
) PARTITION BY LIST (action_date_fiscal_year);

-- Catches rows whose action_date_fiscal_year does not match any attached year.
CREATE TABLE public.assistance_unrouted PARTITION OF public.assistance DEFAULT;
